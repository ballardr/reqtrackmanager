 ...
 * three cross-assignment listings (Non-Compliant, Pending Approval,
 * Reviews Due/Overdue) gathered in one read-only view. Acting on a row
 * happens via the Standards tab (`ApplicabilityTree`/`ReviewsPanel`), not
 * here.
 */
function mockApis(nonCompliant: NonCompliantRequirement[], pending: PendingApproval[], reviewsDue: ComplianceReview[]) {
...
export const WithOutstandingItems: Story = {
  beforeEach: () => mockApis(NON_COMPLIANT, PENDING, REVIEWS_DUE),
