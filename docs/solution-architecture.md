...
**Compliance module** (compliance module Phase 5): `compliance_standards`, `compliance_standard_versions`, `compliance_requirements`, `compliance_required_actions`, `compliance_action_type_definitions`.
