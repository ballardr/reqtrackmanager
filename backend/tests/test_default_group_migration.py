...
from tests.conftest import auth_headers, build_alembic_config, create_org_user, create_project, direct_project_roles
...
def _downgraded_to_0018():
    ...
    command.downgrade(build_alembic_config(), "0018")
    try:
        yield
    finally:
