...
A public documentation website is live at **[ballardr.github.io/reqtrackmanager](https://ballardr.github.io/reqtrackmanager/)** (Docusaurus, built from [docs/website/](docs/website/) and deployed via GitHub Pages — see [docs/plans/docs-website-plan.md](docs/plans/docs-website-plan.md) for how it was built).
